...
//        {
//            updateTreeProfile(resetProfile());
//            Snackbar.make(findViewById(R.id.menu_reset), R.string.snack_bar_reset, Snackbar.LENGTH_LONG).show();
//            return true;
//        }
//        else if (menuID == R.id.menu_about)
//        {
//            AlertDialog.Builder d = new AlertDialog.Builder(this);
//            d.setTitle(R.string.about_alert_title);
